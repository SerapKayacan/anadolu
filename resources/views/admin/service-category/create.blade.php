            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('activity.index') }}" class="text-muted text-hover-primary">Hizmet Kategori Listesi</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea class="form-control" name="sort_detail" rows="2" required></textarea>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
                                                </div>
                                            </div>
                                            <div class="mb-10 row">
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input class="form-control" name="keywords" value="" required/>
                                                    <div class="text-muted fs-7">Bu alan zorunludur.</div>
                                                </div>
                                            </div>
                                            <div class="mb-10 row">
