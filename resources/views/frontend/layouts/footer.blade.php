<footer class="footer" >
    <div class="container">
        <div class="row">
            <div class=" col-lg-1 col-md-1 col-xs-6 row-sm-6 footer-logo">
                <img src="{{ asset('') }}assets/frontend/images/sultanpark-white-logo.png"
                     class="justify-content-center " alt="Bootstrap" width="85"
                     height="75">
            </div>
            <div class=" col-lg-1 col-md-1 col-xs-12 footer-categories">
                    <h2 class="categories-title">Hesabım</h2>
                    <a class="icon-link icon-link-hover footer-link" href="#">
                        Randevularım
                        <svg class="bi" aria-hidden="true">
                            <use xlink:href="#arrow-right"></use>
                        </svg>
                    </a>
                    <a class="icon-link icon-link-hover footer-link"
                       style="width:150px;" href="#">
            ...
            <div class="  col-lg-1 col-md-1col-xs-12 footer-categories" style="margin-left: 40px;">
                <div>
                    <div>
            ...
            <div class="  col-lg-1 col-md-1 col-xs-12 footer-categories" style="margin-left: 40px;">
                <div>
                    <div>
            ...
            <div class=" col-lg-3 col-md-3col-sm-12 footer-card-div">
