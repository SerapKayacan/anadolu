        ...
        <nav style="display:block">
            <ul class="nav justify-content-center" style=" font-size:16px;">
                <li class="nav-item " style=" margin-left:100px; font-weight: 700;">
                    <a class="nav-link active" style="color:#244daa" aria-current="page" href="{{ route('home') }}">Ana Sayfa</a>
                </li>
                <li class="nav-item " style=" margin-left:50px;font-weight: 700;">
                    <a class="nav-link active" style="color:#244daa" aria-current="page" href="{{ route('onlineDoctor.byCategory') }}">Online Doktor Görüşmesi</a>
                </li>
                <li class="nav-item " style=" margin-left:40px;font-weight: 700;">
                    <a class="nav-link active" style="color:#244daa" aria-current="page" href="{{ route('services-category.index') }}">Hizmetlerimiz</a>
                </li>
                <li class="nav-item " style=" margin-left:40px;font-weight: 700;">
                    <a class="nav-link active" style="color:#244daa" aria-current="page" href="{{ route('about-us.index') }}">Hakkımızda</a>
                </li>
                <li class="nav-item " style=" margin-left:40px;font-weight: 700;">
                ...
                <li class="nav-item " style=" margin-right:40px;margin-left:50px;font-weight: 700;">
                    <a class="nav-link active" style="color:#244daa" aria-current="page" href="{{ route('contact.index') }}">İletişim</a>
                </li>
            </ul>
        </nav>
    </div>
    <div class="col-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <ul class="nav justify-content-center " style="background-color:#3b79ac; font-size:15px;padding-top:15px;padding-bottom:15px;">
