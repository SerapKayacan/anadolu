...
@section('content')
    <main>
        <div class="row align-items-center justify-content-center text-center px-3"
             style="background-color:#fbdfdf; height:auto;">
            <div class="col-12 contact-card-header">
                <p class="contact-header">Bizimle İletişime Geçin</p>
                <p class="contact-bottom-header">"Ev, Fabrika ve Garajlar İçin Dayanıklı Kaplamalar, Hastaneler İçin Hijyen!"</p>
            </div>
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px; border: 1px solid #ddd;">
                                    ...
                                    maddesi uyarınca,
                                    veri sorumlusu sıfatıyla [UstaRenovasayon&Epoxy] tarafından hazırlanmıştır.
                                </td>
                            </tr>
                            <tr>
