    ...
    <main>
        <div class="main-wrapper-1" style="background-color:#f6dae0">
            <div class="container main-container-1" style=" height:500px;">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contact-card-all" >
                        ...
                        <div class="card contact-card">
                            <div class="contact-card-head">
                                <div class="row">
                                    ...
                                    <div class="col-6 contact-card-map">
                                        <div>
                                            <iframe
                                ...
                                <form  action="{{ route('contact.submit') }}" method="POST" style="display: flex; flex-wrap: wrap; gap: 20px;">
                                    ...
                                    <div class="modal" id="termsModal">
                                        <div class="modal-content">
                                            ...
                                            <table
                                                style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; background-color: #f9f9f9; border: 1px solid #ddd;">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td style="padding: 10px; border: 1px solid #ddd;">1. Veri
                                                        Sorumlusu
                                                    </td>
                                                    <td style="padding: 10px; border: 1px solid #ddd;">
                                                        Bu aydınlatma metni, 6698 sayılı Kişisel Verilerin Korunması
                                                        Kanunu’nun (“KVKK”) 10. maddesi uyarınca, veri
                                                        sorumlusu sıfatıyla [Şirket Adı / Organizasyon Adı] tarafından
                                                        hazırlanmıştır.
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 10px; border: 1px solid #ddd;">
                                                        Kişisel verileriniz, [web sitesi adı] üzerinden doldurduğunuz
